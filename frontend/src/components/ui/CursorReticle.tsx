...
export const MagneticWrapper: FC<{
  children: ReactNode;
  strength?: number;
}> = ({ children, strength = 0.36 }) => {
    ...
    const tick = () => {
      ...
      if (ringRef.current) {
        ...
        r.style.borderColor = hovering
          ...
          : "rgba(0,245,255,0.6)";
        r.style.backgroundColor = hovering
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          transition:
            "width 0.2s cubic-bezier(0.34,1.4,0.64,1), height 0.2s cubic-bezier(0.34,1.4,0.64,1), border-color 0.15s, background-color 0.15s",
        }}
      />
    </>
  );
